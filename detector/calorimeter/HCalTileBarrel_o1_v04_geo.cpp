...
static dd4hep::Ref_t createHCal(dd4hep::Detector& lcdd, xml_det_t xmlDet, dd4hep::SensitiveDetector sensDet) {
  ...
  for (unsigned int idxLayer = 0; idxLayer < layerDepths.size(); ++idxLayer) {
    ...
    if (seg_phitheta) {
      ...
      dd4hep::printout(dd4hep::INFO, "HCalTileBarrel_o1_v04", "    cell sizes in theta, phi: %lf , %lf", cellSizeTheta,
                       cellSizePhi);
      ...
      double cellSizePhi = cellSizeVector[0];
      dd4hep::printout(dd4hep::INFO, "HCalTileBarrel_o1_v04", "    cell sizes in z, phi: %lf , %lf", cellSizeZ,
                       cellSizePhi);
